...
export default function Home() {
    return (
        <div className="font-sans items-center justify-items-center p-8 pb-20 gap-16 sm:p-20">
            ...
            <section id="contact" className="h-100 items-center justify-center ">
